...
import belletarde.tech.fit.diet_plan.model.DietHighLight
import belletarde.tech.fit.diet_plan.model.DietPlanList
import belletarde.tech.fit.diet_plan.model.ErrorViewModel
import belletarde.tech.fit.diet_plan.presenter.DietPlansPresenter
...
class MainDietActivity : AppCompatActivity(), DietPlansView {
    ...
    private fun setHighLightDiet(highLight: DietHighLight) {
        ...
        dietHeader.btnRecommendedDietSeeMore.setOnClickListener {
            val toDietDetail =
                DietPlanDetailActivity.newIntent(this, highLight.id)
